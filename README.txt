...
- Verificação de Lint (ESLint):        npm run lint
...
Consulte README.md, INSTALL_LINUX.md, INSTALL_WINDOWS.md, INSTALL_MACOS.md
e CLOUD_SESSIONS.md para detalhes adicionais de configuração.
================================================================================
